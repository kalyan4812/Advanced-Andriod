package com.example.advancedandriod_1.CameraX;
...
import com.example.advancedandriod_1.MainActivity;
...
public class Camerax extends AppCompatActivity {
    ...
    private void startCamera() {
        ...
        mCameraView.bindToLifecycle((LifecycleOwner) Camerax.this);
        ...
        btnLens.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ActivityCompat.checkSelfPermission(Camerax.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    // TODO: Consider calling
                    //    ActivityCompat#requestPermissions
                    // here to request the missing permissions, and then overriding
                    //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
